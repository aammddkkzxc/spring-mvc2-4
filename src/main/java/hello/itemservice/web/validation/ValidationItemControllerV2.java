...
//                bindingResult.addError(new ObjectError("item",  "가격 * 수량 의 합은 10,000원 이상이어야 합니다. 현재 값 = " + resultPrice));
//            }
//        }
//
//        //검증에 실패하면 다시 입력 폼으로
...
//
//        if (item.getPrice() == null || item.getPrice() < 1000 || item.getPrice() >
//                1000000) { bindingResult.addError(new FieldError("item", "price", item.getPrice(),
